...
### Action Plan
If I had to buik the Song list element of the app was probably enough to be it's own app. I think if I had my time again, I would just make the app a "setlist builder" and I would incorporate the Spotify API. Lesson learned......
***
