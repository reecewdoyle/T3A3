...
* Regardless of what language a developer is working in, they need a strong understanding of algorithms and data structures to be able to solve complex problems efficiently. Developers that can do this design optimised, high performing, scalable code. This would include but not be limited to being able to use Arrays, Hash Tables, Binary Trees,  
