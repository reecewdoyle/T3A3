...
This can also be the things that you want to go into your database. In your particular case, this could be where we design the Application Programming Interface (API). This is the interface we build that will allow your website to effectively communicate with the data in your database. I'm sure you have a very extensive catalog of information about each of your items on display or in storage.  
