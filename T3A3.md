...
I discovered that there is also a `Slack` group for local programmers that I've requested to join. As of writing, I've not been accepted, but it seems like this is much like a discord chann
