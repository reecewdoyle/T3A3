...
```javascript
{ "item_id": "001", "name": "Viking's Toothbrush", "category": "Historical Artefact", "description": "An ancient Viking-era toothbrush, believed to have been carved from a whale bone and used with herbal pastes. Surprisingly ergonomic for its time!", "origin": { "region": "Scandinavia", "estimated_year": 975, "discovered_at": "Norwegian coast", "discovered_by": "Dr. Ingrid Yngvar" }, "dimensions": { "length_cm": 12.5, "width_cm": 1.8, "weight_g": 50 },
```
