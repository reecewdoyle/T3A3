...
* NodeJS: This is the server side package that allows the frontend of your website to communicate with the backend. It also allows us to use JavaScript for both frontend and backend, 
