...
* MongoDB: is a highly scalable, non-Relational Database that will store all the information related to your exhibits. It is good for handling very large amounts data about just about anything. This could include but is not limited to data about your displays, past and future events, customer contact details, a booking system, educational resources and much more. The Database can grow with the SAM.
