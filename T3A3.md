...
This can also be the things that you want to go into your database. In your particular case, this could involve designing an Application Programming Interface (API).  that will be used to access what I'm sure is a very extensive catalog of data you have available for each item you store and display. This might include names of items, country of origin, serial number etc. 
