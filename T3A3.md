...
I imagine that you're going to havThis will also be when we start to design the API for your database. An API (Application Programming Interface) is something we create for you that allows your database to talk to your user interface. This is how information will be created, retrieved, updated or deleted in your system. This is one of those big, boring, backend things that's not intended to be visually stimulating, yet still brings overwhelming satisfaction to our developers. We have some developers in our team that greatly prefer this to the design work, so that's what they mostly focus on.  

#### 4. Content Writing 
This is when we make sure that you've got all the content that you want to go on your website to us. This is mostly the text based content. We can do our best and try to make up some cool facts about the things found in the SAM, but from experience, we feel that this part is best handled by the experts; you! 
