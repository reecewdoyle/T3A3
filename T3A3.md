...
### Action Plan
If I had to build this app again, I would start with something simple and small.  The Song list element of this app would've been more than enough to meet the criteria of the assignment and would be more inline with my skillset. I would make the app a "setlist builder" and I would incorporate the Spotify API, as there is plenty of 
***
