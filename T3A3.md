...
AI systems are trained on vast sets of data that are flawed biased. If an LLM is not trained on a broad set of texts that show multiple perspectives, it risks exacerbating errors, reproducing biases and prejudices. 
