...
This can also be the things that you want to go into your database. In your particular case, this could be where we design the Application Programming Interface (API) 
