...
There is a fear that AI will take over jobs, but we aren't there yet. This phenomenon, known as **FOBO (Fear of Being Obsolete)**, isn’t unique to software development or even the tech industry. It has appeared in various industries throughout history.

A famous example of this FOBO is expressed in the folklore of American Hero "John Henry", which dates back as far as the 1840s, and is to topic of the 1963 Johnny Cash song "The Legend of John Henry's Hammer". Johnny demonstrates my point with a parabole more elegent than I could ever construct myself, so I'm going to quote him 

The protagonist (John Henry), is a railway worker who does hard labour for work, laying train tracks by hand, and splitting rocks enough so that dynamite can be placed. He learns that he is to be replaced by a steam drill. 
...
Determined to prove that he could outwork innovation, and technology to stay relevant, John Henry challenges the steam drill to a head-to-head competition. Miraculously, against all odds, John Henry wins the contest, but dies the following day of exhaustion. 



The obvious answer is that people adapted. People like John Henry became the steam drill drivers. But there was obviously a period of adjustment and anxiety, which is where we are now. This happens in every industry, and will always happen in every industry. 
...
People are going to adapt. They're going to realise that LLM's like ChatGPT aren't replacement  employees. They're a tool that can streamline some of their more repetitive and boring tasks, allowing them to get to the tasks that require the human touch (creativity, critical thinking) quicker.  

Sadly for John Henry, he refuses to adapt and perishes as he attempts to out perform the steam drill. 
