...
There are many more example that I could got through, but they're all going to be essentially some expansion on generating, translating, or checking code. 
...
But ChatGPT and other language-learning models still aren't able to make decisions about why we are creating an application, or how it works once it's in the hands of the end user. That will always be the job of a human, as it humans who use the apps that the developer creates. 
***
### References
