...
#### 4. Content Writing 
This is when we make sure that you've got all the content that you want to go on your website to us. This is mostly the text based content, much of which will end up in the database, accessed by the API that we designed in the previous step. We'll guide you with the format that the data should come in, and we can turn that into a We can do our best and try to make up some cool facts about the things found in the SAM, but from experience, we feel that this part is best handled by the experts; you! 
