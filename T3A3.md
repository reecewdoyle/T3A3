...
There are significant legal an ethical implications to using language-learning models (LLM) technologies like ChatGPT in the written and technical works.
...
Followed to the logical conclusion, you could train an LLM on purpose to be extremely bigoted. 
...
While there is a fear that AI is going to take jobs, we aren't there yet. The phenomenon is not new. It's now got a name; FOBO (Fear of Obsolescence), and it's not unique to software development, or even the tech industry. This is something that happens in every industry.  
