...
##### Adaptability
* Technology is in a constant state of flux, meaning that there is always going to be new tools, programming languages and processes to learn. There is also always going to be new problems to solve in new fields. Successful devs are able to adapt to ever changing environments and settings by keeping up with new knowl
