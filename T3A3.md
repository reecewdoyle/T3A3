...
* Responsil: writing, testing and maintaining code for the applications and systems. They can sometimes be divided into teams that work in different areas:
...
#### DevOps Engineer
* Tasks: An intermediary between development and operations. They automate deployment, ensure reliability, manage infrastructure, and monitor applications. They use tools like Docker, Kubernotes, or cloud apps like AWS and Azure. 
