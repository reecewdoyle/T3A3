...
People are going to adapt. They're going to realise that LLM's like ChatGPT aren't replacement  employees. While they're going to improve, they're far from perfect. They're a tool that can streamline some of the more repetitive and mundane tasks, allowing developers to get to the tasks that require the human touch (creativity, critical thinking) quicker.  
