...
Being in based in Newcastle NSW, my network is a bit smaller than it would be if I was living in a capital city, which just means I might have to work a bit harder, or potentially look at online opportunities. 

I discovered that there are many resources and communities that I could be tapping into specific to my area. 

### Networking Events

On` Meetup.com` I found the Newcastle Coders Group and joined that. 
![newy-code1](newy-code1.png)
Immediately I found two events that I can attend for free this year. 
![newy-code2](newy-code2.png)
It appears that hey have some kind of networking opportunity at least once per month, so I can immediately begin attending these regularly. 
![newy-code3](newy-code3.png)

### Local Slack Group

I discovered that there is also a `Slack` group for local programmers that I've requested to join. As of writing, I've not been accepted, but it seems like this is much like a discord channel where I would be able to communicate and possibly at least make some connections with local developers. 

![newy-code4](newy-code4.png)

### Recruiters

I found that there is a tech specific recruiter located in Newcastle called Newy Tech People. 
![newy-code5](newy-code5.png)

I was encouraged to discover that they had a contact page, so I've sent through my most recent CV to discuss opportunities for an Internship that will hopefully lead to a Junior position. 

![newy-code6](newy-code6.png)


### Podcast

I discovered that Newy Tech People also has a podcast, so I've started listening to this as well. This has given me a great insight into how many tech businesses there actually are in the Newcastle and Hunter Area. It's far more than I though! It's also giving me some names of quite successful people I can learn about. 

![newy-code7](newy-code7.png)

### Hackathons

Finally, I found a few Hackathons that are based in Australia that I could attend in a Hackathons Australia Facebook Group.

![newy-code9](newy-code9.png)
***

### References

Newcastle Coders Group
https://www.meetup.com/newcastle-coders-group/

Newwwie Programers Slack Group.
https://newwwie.com/#about

Newy Tech People - Recruiter
https://newytechpeople.com.au
...
While this is obviously a humorous example, following through to the logical conclusion, you could train an LLM on purpose to be extremely bigoted or incompetent. This could have catastrophic real-world consequences in both medical and financial applications. 
...
Determined to prove that he could outwork innovation and technology to stay relevant, John Henry challenges the steam drill to a head-to-head competition.

Miraculously, and against all odds, John Henry wins the contest, but dies the following day of exhaustion as the steam drill is powered up for another day of work. 
