...
##### Problem Solving
* A large part of the job as a developer is finding solutions to challenges in a creative and efficient manner. This involves a lot of critical and creative thinking. It's one thing to know what a piece of code does, but it's quite another thing to know when it can be applied to a situation. There would also be a certain element of calculated risk taking, as there is a possiv
##### Time Management
##### Adaptability
